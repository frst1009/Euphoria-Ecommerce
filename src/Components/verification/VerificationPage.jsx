...
const VerificationPage = () => {
  ...
  const validationschema = Yup.object().shape({
    name: Yup.string().email(t("reset_email")).required(t("email_formik")),
  });
      ...
      <div className="flex flex-col container  ">
        <div className="md:pt-10 pb-8">
          ...
          <div className="flex flex-col gap-3 ">
            <h6 className="md:text-xl  lg:text-sm text-gray-500">
              {t("verify")}{" "}
            </h6>
              ...
              {({ isSubmitting }) => (
                <Form className="pt-4">
                  <div className="flex flex-col mb-3">
                    ...
                    <ErrorMessage
                      name="name"
                      className="errormessage md:text-xl lg:text-sm"
                      component="div"
                    />
                  </div>
